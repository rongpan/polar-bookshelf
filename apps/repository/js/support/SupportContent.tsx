...
export function SupportContent(props: IProps) {
                            ...
                            <div className="row" id="support">
                                ...
                                <div className="col">
                                    ...
                                    <NullCollapse open={plan === 'free'}>
                                        ...
                                        <p className="text-xl">
                                            Polar has two main support options.
                                            Premium and
                                            Community.
                                        </p>
                                        ...
                                        <p className="text-lg">
                                            ...
                                            Premium</a> benefit
                                            from direct support with 24 hour
                                            response
                                            time. This includes
                                            the <b>bronze</b>,
                                            <b>silver</b>,
                                        ...
                                        <p className="text-lg">
                                            Additionally, bug fixes and feature
                                            requests from
                                            premium users carry greater priority
                                            in our
                                            milestone
                                            planning.
                                        </p>
                                        ...
                                        <p className="text-lg">
                                            Users on the free tier can use our
                                            community
                                            resources
                                            and reach out on <a
                                        ...
                                        <p className="text-lg">
                                            We try our best to address your
                                            issues but obviously
                                            we focus on premium users first.
                                            Premium also means
                                            you take advantage of all the other
                                            features
                                            included
