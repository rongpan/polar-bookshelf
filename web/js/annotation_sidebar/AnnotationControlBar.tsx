    ...
    public render() {
        ...
        const ChangeTextHighlightButton = () => {
            ...
            return <Button className="text-muted p-1"
                           ...
                           onClick={() => this.toggleActiveInputComponent('edit-text-highlight')}>
        ...
        return (
            ...
            <div style={{userSelect: 'none'}}
                ...
                <EditTextHighlight id={annotation.id}
                                   ...
                                   active={this.state.activeInputComponent === 'edit-text-highlight'}
...
type ActiveInputComponent = 'none' | 'comment' | 'flashcard' | 'edit-text-highlight';
